        ...
        <div className="tp-porfolio-10-area tp-porfolio-10-height p-relative">
            <div className="tp-porfolio-10-bg-wrap">
                <div id="tp-porfolio-10-bg-box" className={activeBg ? activeBg : ""}>
                    <BgImg imgSrc="/assets/img/update/interactive-img/port-1.jpg" id="1" />
                    <BgImg imgSrc="/assets/img/update/interactive-img/port-2.jpg" id="2" />
                    <BgImg imgSrc="/assets/img/update/interactive-img/port-3.jpg" id="3" />
                    <BgImg imgSrc="/assets/img/update/interactive-img/port-4.jpg" id="4" />
                    <BgImg imgSrc="/assets/img/update/interactive-img/port-5.jpg" id="5" />
                    <BgImg imgSrc="/assets/img/update/interactive-img/port-6.jpg" id="6" />
                    <BgImg imgSrc="/assets/img/update/interactive-img/port-7.jpg" id="7" />
                    <BgImg imgSrc="/assets/img/update/interactive-img/port-5.jpg" id="8" />
                </div>
            </div>
