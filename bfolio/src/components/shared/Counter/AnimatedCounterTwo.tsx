...
export default function AnimatedCounterTwo({ min, max, cls = 'purecounter', suffix }: CounterProps) {
    const [counted, setCounted] = useState<number>(min);
    const targetElement = useRef<HTMLHeadingElement>(null);
    ...
    return <h2 ref={targetElement} className={cls}>
        {counted}
        {suffix && suffix}
    </h2>;
}
